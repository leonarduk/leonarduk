...
- **[Python Institute PCEP-30 + PCAP-31 Certification Practice Tests](https://www.udemy.com/course/python-institute-pcep-pcap-practice-tests/)** *(published, beta)* —
  ...
  challenges), covering both certifications' full syllabi. In beta — use code `PYTHON_BETA` for
  free access in exchange for feedback.
  — [python-udemy-practice-tests](https://github.com/leonarduk/python-udemy-practice-tests) *(private)*, from [python-cert-prep](https://github.com/leonarduk/python-cert-prep) *(private)*
