...
- [issue-worm-core](https://github.com/leonarduk/issue-worm-core) *(private)* — the multi-agent engine: Coder→Verifier→Analyser orchestration loop, scheduler (poll/dispatch/label lifecycle), the coder/analyser/triage agents, and the [cicaid-pro](https://github.com/leonarduk/cicaid-pro) bridge
